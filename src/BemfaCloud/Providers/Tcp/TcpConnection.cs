...
{
    internal sealed class TcpConnection : NetConnection<ITcpConnection, NetClientEventArgs<ITcpConnection>>, ITcpConnection, IDisposable
    {
        ...
        internal TcpConnection(Socket socket)
        {
            ...
            Instance = socket;
            LocalEndPoint = socket.LocalEndPoint.As();
            RemoteEndPoint = socket.RemoteEndPoint.As();
        ...
        private void OnConstructing()
        {
            ...
            try
            {
                ...
                RemoteEndPoint = _remote;
                if (_local?.Port > 0) LocalEndPoint = _local;
